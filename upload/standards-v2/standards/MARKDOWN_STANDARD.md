...
> Related: No-Unicode Policy v2.2 (STD-DOC-003) — character rules delegated to this standard
> verified_by: scripts/verify-standards.js#V08 (§4.3 + §5.4 — code fences must have language tag)
...
**See also:**
- **No-Unicode Policy v2.2** — for UI components [C], production code [C], AI-communication [W], prototypes [I]

---

## 3. Prohibited Elements

Character prohibitions are defined in **No-Unicode Policy v2.2** (STD-DOC-003) sections 4-5. Level **[C] Critical** applies to documentation files — same severity as source code (same rule = same severity).
