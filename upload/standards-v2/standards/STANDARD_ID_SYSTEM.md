...
> verified_by: scripts/verify-standards.js#V05 (registry includes STD-DESIGN-001 + STD-FE-001 v2.5+)
...
| `DESIGN` | Design System | Token system, typography, color, spacing, card archetypes |
...
|----|----------|---------|-------|--------|
| STD-FE-001 | Frontend Development Standard | 2.5 | [C] Critical | ACTIVE |
...
| STD-DOC-003 | No-Unicode Policy | 2.2.0 | [C]+[W]+[I] | ACTIVE |
...
| STD-ENV-002 | Z.ai Integration Standard | 1.3 | [C] Critical | ACTIVE |
