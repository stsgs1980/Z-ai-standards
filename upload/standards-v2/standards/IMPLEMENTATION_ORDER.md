...
| STD-DESIGN-001 | Design System Standard: Step 3 design token setup (Core + Profile), token integration patterns, agent context generation |
| ZAI-ARCH-002 | Anti-Monolith Skill: Path B refactoring — auto-activates when component thresholds exceeded; 7-step decomposition strategy |
