...
> Related: Frontend Development (STD-FE-001), Markdown Standard v2.2 (STD-DOC-002), No-Unicode Policy v2.1 (STD-DOC-003)
...
Character and icon rules follow **No-Unicode Policy v2.1** (STD-DOC-003).
...
Documentation files must comply with **Markdown Standard v2.2** (STD-DOC-002):
